      ...
      <div className={styles.inner}>
        <div className={styles.left}>
          ...
          <p className={styles.tagline}>
            ...
            Bridging modern &amp; legacy architectures.
          </p>
          ...
          <div className={styles.socials}>
            <a href="https://github.com/Peterms0228" target="_blank" rel="noreferrer" className={styles.social}>
              <GithubIcon /> GitHub
            </a>
            <a href="https://linkedin.com/in/meng-sin-chua-648812281" target="_blank" rel="noreferrer" className={styles.social}>
